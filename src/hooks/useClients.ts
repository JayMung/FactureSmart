 ...
 */
function createGenericCrudHook<T extends { id: string | number }, CreateData>(
  options: {
    tableName: string;
    entityName: string;
    getAll: (page?: number, pageSize?: number, filters?: any) => Promise<ApiResponse<PaginatedResponse<T>>>;
